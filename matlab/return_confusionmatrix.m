% Lo stesso script di computeaccuracy ma implementato per restituirmi la
% confusion matrix per fare quello che voglio io

function ConfM = return_confusionmatrix(data,labels_test,labels_pred,classes,method_name,desc_test,visualize_confmat,visualize_res)
    for i=1:length(data)
    ...
    %calculateMacroF1Score(CMnorm, classes);
