...
[trainLBP,testLBP, valLBP] = lbp_color_extraction_val(data,length(classes),num_train_img,num_test_img,num_val_img,info);
...
%metodo non rivisitato con validation
